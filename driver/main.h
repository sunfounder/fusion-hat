...
// I2C communication
int fusion_hat_i2c_read_byte(struct i2c_client *client, uint8_t cmd,
                             uint8_t *value);
int fusion_hat_i2c_write_byte(struct i2c_client *client, uint8_t cmd,
                              uint8_t value);
int fusion_hat_i2c_read_word(struct i2c_client *client, uint8_t cmd,
                             uint16_t *value, bool big_endian);
int fusion_hat_i2c_write_word(struct i2c_client *client, uint8_t cmd,
                              uint16_t value, bool big_endian);
int fusion_hat_i2c_read_block_bytes(struct i2c_client *client, uint8_t cmd,
                                    uint8_t *buffer, uint8_t len);

// ADC
int fusion_hat_read_adc(struct i2c_client *client, int channel,
                        uint16_t *value);
...
ssize_t button_show(struct device *dev, struct device_attribute *attr,
                    char *buf);
